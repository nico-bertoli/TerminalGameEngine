...
#include <terme/SimEntities/ISimulationEntity.h>
#include <terme/SimEntities/GameObject.h>
#include <terme/SimEntities/Level.h>
#include <terme/Managers/TimeManager.h>
#include <terme/Core/WorldSpace.h>
#include <terme/Managers/DebugManager.h>
#include <terme/Utils/RandomUtils.h>
#include <terme/SimEntities/Particle.h>
				...
				if (collider_obj != nullptr)
				{
					...
					for (auto colliding_obj : out_colliding_objects)
						if (colliding_obj != WorldSpace::kScreenMargin)
							colliding_obj->CALLED_BY_SIM_NotifyCollisionEnter(collider_obj, DirectionUtils::GetInverseDirection(direction));
				}
			}
			return false;
		}
